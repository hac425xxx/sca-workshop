 ...
 */
private class CustomMemcpyFunction extends ArrayFunction, DataFlowFunction, SideEffectFunction {
  CustomMemcpyFunction() {
    // custom_memcpy(dest, src, num)
    this.hasName(["custom_memcpy"])
  }
